...
// Create a random rumber between 0.1 to 0.2, keep the values at 1 decimal
...
for (let y = 0; y < height; y++) {
    ...
    for (let x = 0; x < width; x++) {
        ...
        // Generate a random value betwteen 0.1
        const ceiling = Math.round(Math.random() * 10) / 10;
        // If the limit is less than the ceiling, fill with the fieldCharacter - otherwise,
